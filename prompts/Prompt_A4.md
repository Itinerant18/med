Create a new file lib/features/profile/assistant_profile_screen.dart. This is shown to users with role == UserRole.assistant. It has a simpler profile with limited info and no admin sections:

Create a new file lib/features/profile/doctor_profile_screen.dart with the following full implementation. This is the admin profile shown only to users with role == UserRole.doctor:
